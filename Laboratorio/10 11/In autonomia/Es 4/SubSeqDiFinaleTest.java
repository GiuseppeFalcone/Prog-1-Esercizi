public class SubSeqDiFinaleTest {
	public static void main(String[] args) {
		...
		System.out.println(SubSeqDic.sottoSeq(a0, b)== 1);
		System.out.println(SubSeqDic.sottoSeq(a1, b)== 4);
		System.out.println(SubSeqDic.sottoSeq(a2, b)==-1);
		System.out.println(SubSeqDic.sottoSeq(a3, b)==-1);
	}
}