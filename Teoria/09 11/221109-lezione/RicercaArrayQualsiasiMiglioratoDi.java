...
public class RicercaArrayQualsiasiMiglioratoDi {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(ricercaArrayQualsiasi(new int[] {2,1,3,2,2,2}, 1) == 1);
  }
      ...
      if (l+1==r) { // un elemento in [l, l+1)
        if (a[l]==v) { // l'unico elemento è uguale a v
         ...
         if (a[m]==v) {
           ...
           /* v può essere nei due intervalli 
              - a[l..m)
              - a[m+1..r) con estremo inferiore par a m+1
           */
           int indiceSx = ricercaArrayQualsiasi(a, v, l, m);
                 /* È possibile cercare v in a[l..m) come fatto sinora */         
           /*  indiceSx == -1 se v non è in a[l..m) 
               indiceSx == i se a[i]==v e a[0..i)!=v */
           if (indiceSx != -1) {
              return indiceSx;
              /* È inutile cercare nell'intervallo destro */
           } else {
               /* v non è stato trovato in a[l..m) */
              return ricercaArrayQualsiasi(a, v, m+1, r); 
               /*  indiceDx == -1 se v non è in a[m+1..r)
                   indiceDx == i se a[i]==v e a[m+1..i)!=v 
                   tenendo conto del fatto che a[m+1..r) 
                   può anche avere 0 elementi */
           }
         }
      } 
    } else {
